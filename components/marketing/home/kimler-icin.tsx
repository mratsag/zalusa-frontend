...
const CARDS = [
  { icon: "ph-user", wrap: "bg-emerald-50 text-emerald-600 border-emerald-200/70", label: "Bireysel Göndericiler", extra: "" },
  { icon: "ph-rocket-launch", wrap: "bg-orange-50 text-orange-600 border-orange-200/70", label: "Startuplar", extra: "" },
  { icon: "ph-storefront", wrap: "bg-cyan-50 text-cyan-600 border-cyan-200/70", label: "KOBİ'ler", extra: "" },
  { icon: "ph-buildings", wrap: "bg-purple-50 text-purple-600 border-purple-200/70", label: "Şirketler", extra: "" },
  { icon: "ph-globe-hemisphere-west", wrap: "bg-indigo-50 text-[#0000BE] border-indigo-200/70", label: "Sektör Devleri", extra: "col-span-2 sm:col-span-1" },
];

export function KimlerIcin() {
  return (
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center max-w-2xl mx-auto mb-12 md:mb-16">
          ...
          <h2 className="text-[32px] md:text-[44px] font-semibold tracking-tight text-slate-900 leading-[1.1]">
            Herkes için <span className="text-[#0000BE]">Tek Lojistik Paneli</span>.
          </h2>
          <p className="mt-4 text-base md:text-[17px] text-slate-500 leading-relaxed">
            Küçükten büyüğe, bireysel göndericiden sektör devlerine — herkes Zalusa ile gönderir.
          </p>
        </div>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-4 md:gap-5">
          {CARDS.map((c) => (
            ...
            >
              ...
              <h3 className="text-[15px] md:text-[16px] font-semibold text-slate-900">{c.label}</h3>
            </article>
          ))}
        </div>
      </div>
