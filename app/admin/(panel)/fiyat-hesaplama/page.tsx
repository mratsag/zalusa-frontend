    ...
    <div className="space-y-5 pb-10">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-[12px] sm:text-[13px] text-[#64748B] font-medium mt-0.5 leading-relaxed">Rota ve paket bilgilerini girin, anında kargo fiyatlarını karşılaştırın. (Admin)</p>
        </div>
      </div>
          ...
          {quotes.length > 0 && (
            <div className="bg-white rounded-[18px] border border-[#E8EDF2] shadow-sm overflow-hidden">
              ...
              <div className="px-3 sm:px-5 py-3 bg-[#F8FAFC] border-t border-[#E8EDF2]">
                <a href="/admin/gonderiler" className="flex w-full items-center justify-center gap-2 rounded-xl bg-[#18181B] px-5 py-3 text-[13px] font-bold text-white shadow-[0_4px_14px_rgba(0,0,0,0.15)] hover:bg-[#27272A] transition-all active:scale-[0.98]">
                  Gönderi Oluştur
